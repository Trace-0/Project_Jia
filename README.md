...
1. [여기](https://github.com/Trace-0/Project_Jia/releases/tag/v1.1.1)에서 파일을 다운로드 받아요.
2. 받은 파일의 압축을 해제해주세요.
...
- [ ] 사운드보드를 추가할 예정입니다.
- [ ] 다인 대화에 최적화된 모습을 보여줄 수 있도록 수정할 예정입니다. (현재는 관련된 처리가 거의 없어 1:1 대화에 더 적합한 모습을 보여줍니다.)
